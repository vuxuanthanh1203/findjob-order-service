...
import { orderSchema } from '@order/validations/order';
import { BadRequestError, IOrderDocument } from '@vuxuanthanh1203/findjob-helpers-lib';

jest.mock('@order/services/order.service');
jest.mock('@vuxuanthanh1203/findjob-helpers-lib');
jest.mock('@order/validations/order');
